...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelector('#flip').addEventListener('click', () => {
        ...
        if (flippedHeads) {
            ...
            document.querySelector('#message').textContent = 'It flipped Heads, so I win!'
            ...
            document.querySelector('#message').textContent = 'Its now Tails, so you lose!'
        ...
        document.querySelector('#heads').textContent = headsRolls
        document.querySelector('#heads-percent').textContent = percentHeads + '%'
        document.querySelector('#tails').textContent = tailsRolls
